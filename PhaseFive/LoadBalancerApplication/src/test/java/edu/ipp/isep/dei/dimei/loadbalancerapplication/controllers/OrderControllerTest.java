...
import static edu.ipp.isep.dei.dimei.loadbalancerapplication.common.ControllersGlobalVariables.ORDER_READ_URL;
...
class OrderControllerTest {
    ...
    void test_GetAllOrders() {
        ...
        when(restTemplate.exchange(ORDER_READ_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);
        ...
        verify(restTemplate, times(1)).exchange(ORDER_READ_URL + "/all", HttpMethod.GET, requestEntity, Object.class);
    ...
    void test_GetAllOrdersFail1() {
        ...
        when(restTemplate.exchange(ORDER_READ_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
    ...
    void test_GetUserOrders() {
        ...
        when(userController.getUserId(jwtTokenDummy)).thenReturn(mockUserResponseEntity);
        ResponseEntity<Object> mockResponseEntity = new ResponseEntity<>(orderDTOS, HttpStatus.OK);
        when(restTemplate.exchange(ORDER_READ_URL, HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);

        ResponseEntity<Object> response = orderController.getUserOrders(jwtTokenDummy);

        verify(userController, times(1)).getUserId(jwtTokenDummy);
        verify(restTemplate, times(1)).exchange(ORDER_READ_URL, HttpMethod.GET, requestEntity, Object.class);
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals(orderDTOS, response.getBody());
    }
    ...
    void test_GetUserOrdersFail1() {
        ...
        when(restTemplate.exchange(ORDER_READ_URL, HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
    ...
    void test_GetUserOrderById() {
        ...
        when(restTemplate.exchange(ORDER_READ_URL + "/" + orderDTO.getId(), HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);

        ResponseEntity<Object> response = orderController.getUserOrderById(jwtTokenDummy, orderDTO.getId());

        verify(userController, times(1)).getUserId(jwtTokenDummy);
        verify(restTemplate, times(1)).exchange(ORDER_READ_URL + "/" + orderDTO.getId(), HttpMethod.GET, requestEntity, Object.class);
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
    ...
    void test_GetUserOrderByIdFail1() {
        ...
        when(restTemplate.exchange(ORDER_READ_URL + "/" + orderDTO.getId(), HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
