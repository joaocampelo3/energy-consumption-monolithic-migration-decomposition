...
public class MerchantEventSubscriber {
    ...
    public void start() throws IOException, TimeoutException {
        ...
        Consumer consumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) {
                ...
                if (eventType.equals(MerchantRoutingKeyEnum.MERCHANT_DELETED.getKey())) {
    ...
    private void handleMerchantEvent(String eventType, MerchantEvent event) throws Exception {
        ...
        if (MerchantRoutingKeyEnum.MERCHANT_DELETED.getKey().equals(eventType)) {
            merchantOrderService.deleteMerchantOrderByOrderId(event.getId(), isEvent);
        } else {
