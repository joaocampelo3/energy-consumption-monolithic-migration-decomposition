...
class MerchantOrderEventSubscriberTests {
    ...
    void test_HandleDelivery_ShipMerchantOrder() throws WrongFlowException, NotFoundException {
        ...
        when(merchantOrderService.shipMerchantOrder(null, merchantOrderUpdateDTO.getId())).thenReturn(merchantOrder);
    ...
    void test_HandleDelivery_DeliveredMerchantOrder() throws WrongFlowException, NotFoundException {
        ...
        when(merchantOrderService.deliverMerchantOrder(null, merchantOrderUpdateDTO.getId())).thenReturn(merchantOrder);
    ...
    void test_HandleDelivery_DeleteMerchantOrder() {
        ...
        doNothing().when(merchantOrderService).deleteMerchantOrderByOrderId(merchantOrderDTO.getId(), isEvent);
