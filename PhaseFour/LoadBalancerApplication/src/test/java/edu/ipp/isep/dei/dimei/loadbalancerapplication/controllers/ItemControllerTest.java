...
class ItemControllerTest {
    ...
    void test_GetAllItems() {
        ...
        when(restTemplate.exchange(ITEM_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);
        ...
        verify(restTemplate, times(1)).exchange(ITEM_URL + "/all", HttpMethod.GET, requestEntity, Object.class);
    ...
    void test_GetAllItemsFail1() {
        ...
        when(restTemplate.exchange(ITEM_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
    ...
    void test_GetUserItems() {
        ...
        when(userController.getUserId(jwtTokenDummy)).thenReturn(mockUserResponseEntity);
        ResponseEntity<Object> mockResponseEntity = new ResponseEntity<>(itemDTOS, HttpStatus.OK);
        when(restTemplate.exchange(ITEM_URL, HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);

        ResponseEntity<Object> response = itemController.getUserItems(jwtTokenDummy);

        verify(userController, times(1)).getUserId(jwtTokenDummy);
        verify(restTemplate, times(1)).exchange(ITEM_URL, HttpMethod.GET, requestEntity, Object.class);
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals(itemDTOS, response.getBody());
    }
    ...
    void test_GetUserItemsFail1() {
        ...
        when(restTemplate.exchange(ITEM_URL, HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
    ...
    void test_GetUserItemById() {
        ...
        when(userController.getUserId(jwtTokenDummy)).thenReturn(mockUserResponseEntity);
        ResponseEntity<Object> mockResponseEntity = new ResponseEntity<>(itemDTO, HttpStatus.OK);
        when(restTemplate.exchange(ITEM_URL + "/{itemId}", HttpMethod.GET, requestEntity, Object.class, itemDTO.getId())).thenReturn(mockResponseEntity);

        ResponseEntity<Object> response = itemController.getUserItemById(jwtTokenDummy, itemDTO.getId());

        verify(userController, times(1)).getUserId(jwtTokenDummy);
        verify(restTemplate, times(1)).exchange(ITEM_URL + "/{itemId}", HttpMethod.GET, requestEntity, Object.class, itemDTO.getId());
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals(itemDTO, response.getBody());
    }
    ...
    void test_GetUserItemByIdFail1() {
        ...
        ResponseEntity<Object> mockUserResponseEntity = new ResponseEntity<>(mockUserControllerResponse, HttpStatus.OK);
        when(userController.getUserId(jwtTokenDummy)).thenReturn(mockUserResponseEntity);
        when(restTemplate.exchange(ITEM_URL + "/{itemId}", HttpMethod.GET, requestEntity, Object.class, itemDTO.getId())).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
