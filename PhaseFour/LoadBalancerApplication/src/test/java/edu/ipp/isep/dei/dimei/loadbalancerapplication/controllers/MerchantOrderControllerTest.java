...
class MerchantOrderControllerTest {
    ...
    void test_GetAllMerchantOrders() {
        ...
        when(restTemplate.exchange(MERCHANT_ORDER_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);
        ...
        verify(restTemplate, times(1)).exchange(MERCHANT_ORDER_URL + "/all", HttpMethod.GET, requestEntity, Object.class);
    ...
    void test_GetAllMerchantOrdersFail1() {
        ...
        when(restTemplate.exchange(MERCHANT_ORDER_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
    ...
    void test_GetUserMerchantOrders() {
        ...
        when(userController.getUserId(jwtTokenDummy)).thenReturn(mockUserResponseEntity);
        ResponseEntity<Object> mockResponseEntity = new ResponseEntity<>(merchantOrderDTOS, HttpStatus.OK);
        when(restTemplate.exchange(MERCHANT_ORDER_URL, HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);

        ResponseEntity<Object> response = merchantOrderController.getUserMerchantOrders(jwtTokenDummy);

        verify(userController, times(1)).getUserId(jwtTokenDummy);
        verify(restTemplate, times(1)).exchange(MERCHANT_ORDER_URL, HttpMethod.GET, requestEntity, Object.class);
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals(merchantOrderDTOS, response.getBody());
    }
    ...
    void test_GetUserMerchantOrdersFail1() {
        ...
        when(restTemplate.exchange(MERCHANT_ORDER_URL, HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
    ...
    void test_GetUserMerchantOrderById() {
        ...
        when(restTemplate.exchange(MERCHANT_ORDER_URL + "/" + merchantOrderDTO.getId(), HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);

        ResponseEntity<Object> response = merchantOrderController.getUserMerchantOrderById(jwtTokenDummy, merchantOrderDTO.getId());

        verify(userController, times(1)).getUserId(jwtTokenDummy);
        verify(restTemplate, times(1)).exchange(MERCHANT_ORDER_URL + "/" + merchantOrderDTO.getId(), HttpMethod.GET, requestEntity, Object.class);
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
    ...
    void test_GetUserMerchantOrderByIdFail1() {
        ...
        when(restTemplate.exchange(MERCHANT_ORDER_URL + "/" + merchantOrderDTO.getId(), HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
