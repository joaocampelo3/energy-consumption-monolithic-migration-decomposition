...
class OrderEventSubscriberTests {
    ...
    void beforeEach() throws IOException, TimeoutException {
        ...
        Order order = new Order(1, orderDate, OrderStatusEnum.PENDING, 1);
        orderCreateDTO = new OrderCreateDTO(order);
    ...
    void handleDeliverySkelleton(Envelope envelope, OrderEvent orderEvent) throws IOException, InterruptedException {
        // Arrange
    ...
    @Test
    void test_HandleDelivery_CreateOrder() throws IOException, InterruptedException, NotFoundException {
        // Arrange
    ...
    @Test
    void test_HandleDelivery_FullCancelOrder() throws IOException, InterruptedException, WrongFlowException, BadPayloadException, NotFoundException {
        // Arrange
    ...
    @Test
    void test_HandleDelivery_RejectOrder() throws IOException, InterruptedException, WrongFlowException, BadPayloadException, NotFoundException {
        // Arrange
