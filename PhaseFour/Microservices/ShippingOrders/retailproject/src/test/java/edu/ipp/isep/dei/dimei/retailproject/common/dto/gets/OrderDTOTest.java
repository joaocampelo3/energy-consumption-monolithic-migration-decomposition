...
class OrderDTOTest {
    ...
    void beforeEach() throws InvalidQuantityException {
        ...
        orderDTOExpected = new OrderDTO(id, orderDate, orderStatus, customerId, null, totalPrice, null);
    }

    @Test
    void test_createOrderDTO() {
        OrderDTO orderDTO = new OrderDTO(id, orderDate, orderStatus, customerId, null, totalPrice, null);
