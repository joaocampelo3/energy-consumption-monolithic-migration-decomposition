...
class OrderServiceTests {
    ...
    void beforeEach() throws InvalidQuantityException {
        ...
        orderCreateDTO = OrderCreateDTO.builder().orderDate(currentDateTime).customerId(userDTO.getUserId()).email(userDTO.getEmail()).merchantId(merchantId).address(shippingAddressDTO).userDTO(userDTO).build();
        ...
        merchantOrderDTO1 = new MerchantOrderDTO(merchantOrder1.getId(), merchantOrder1.getOrderDate(), merchantOrder1.getStatus(), userDTO.getUserId(), userDTO.getEmail(), order1.getId(), merchantId);
