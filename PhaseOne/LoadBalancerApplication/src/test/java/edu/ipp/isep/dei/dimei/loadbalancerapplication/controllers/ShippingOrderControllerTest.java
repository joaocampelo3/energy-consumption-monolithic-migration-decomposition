...
class ShippingOrderControllerTest {
    ...
    void test_GetAllShippingOrders() {
        ...
        when(restTemplate.exchange(SHIPPING_ORDER_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);
        ...
        verify(restTemplate, times(1)).exchange(SHIPPING_ORDER_URL + "/all", HttpMethod.GET, requestEntity, Object.class);
    ...
    void test_GetAllShippingOrdersFail1() {
        ...
        when(restTemplate.exchange(SHIPPING_ORDER_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
    ...
    void test_GetUserShippingOrders() {
        ...
        when(userController.getUserId(jwtTokenDummy)).thenReturn(mockUserResponseEntity);
        ResponseEntity<Object> mockResponseEntity = new ResponseEntity<>(shippingOrderDTOS, HttpStatus.OK);
        when(restTemplate.exchange(SHIPPING_ORDER_URL, HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);

        ResponseEntity<Object> response = shippingOrderController.getUserShippingOrders(jwtTokenDummy);

        verify(userController, times(1)).getUserId(jwtTokenDummy);
        verify(restTemplate, times(1)).exchange(SHIPPING_ORDER_URL, HttpMethod.GET, requestEntity, Object.class);
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals(shippingOrderDTOS, response.getBody());
    }
    ...
    void test_GetUserShippingOrdersFail1() {
        ...
        when(restTemplate.exchange(SHIPPING_ORDER_URL, HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
    ...
    void test_GetUserShippingOrderById() {
        ...
        when(restTemplate.exchange(SHIPPING_ORDER_URL + "/" + shippingOrderDTO.getId(), HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);

        ResponseEntity<Object> response = shippingOrderController.getUserShippingOrderById(jwtTokenDummy, shippingOrderDTO.getId());

        verify(userController, times(1)).getUserId(jwtTokenDummy);
        verify(restTemplate, times(1)).exchange(SHIPPING_ORDER_URL + "/" + shippingOrderDTO.getId(), HttpMethod.GET, requestEntity, Object.class);
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
    ...
    void test_GetUserShippingOrderByIdFail1() {
        ...
        when(restTemplate.exchange(SHIPPING_ORDER_URL + "/" + shippingOrderDTO.getId(), HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
