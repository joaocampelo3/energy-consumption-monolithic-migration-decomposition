...
public class ItemService {
    ...
    public ItemDTO createItem(ItemDTO itemDTO) throws InvalidQuantityException {
    ...
    public ItemDTO addItemStock(int id, ItemUpdateDTO itemUpdateDTO) throws NotFoundException, InvalidQuantityException, BadPayloadException {
        return changeItemStock(id, itemUpdateDTO, "addItemStock");
    ...
    public ItemDTO removeItemStock(int id, ItemUpdateDTO itemUpdateDTO) throws BadPayloadException, NotFoundException, InvalidQuantityException {
        return changeItemStock(id, itemUpdateDTO, "removeItemStock");
    }

    private ItemDTO changeItemStock(int id, ItemUpdateDTO itemUpdateDTO, String action) throws BadPayloadException, NotFoundException, InvalidQuantityException {
