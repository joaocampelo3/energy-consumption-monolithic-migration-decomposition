...
public class OrderEvent {
    ...
    public Order toOrder() throws InvalidQuantityException {
        ...
        for (ItemQuantityDTO itemQuantityDTO : this.orderItems) {
            itemQuantities.add(itemQuantityDTO.dtoToEntity());
        }
        return new Order(this.id, this.orderDate, this.orderStatus, this.customerId, itemQuantities, this.paymentDTO.dtoToEntity());
    }
}
