...
class MerchantEventSubscriberTests {
    ...
    void beforeEach() throws IOException, TimeoutException {
        ...
        addressDTO = AddressDTO.builder()
                ...
                .country("USA")
                .build();
        merchantDTO = new MerchantDTO(1, "merchant 1", "merchant1@gmail.com");
    }
    ...
    void handleDeliverySkeleton(Envelope envelope, MerchantEvent merchantEvent) throws IOException, InterruptedException {
        // Arrange
    ...
    void handleDelivery_DeleteMerchant(String routingKey, MerchantDTO merchantDTO) throws IOException, InterruptedException {
        ...
        handleDeliverySkeleton(envelope, merchantEvent);
    }
