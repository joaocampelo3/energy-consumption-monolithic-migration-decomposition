...
class OrderControllerTests {
    ...
    void test_DeleteOrder() throws NotFoundException {
        ...
        int id = 1;
        int userId = 1;
        when(orderService.deleteOrder(userId, id, false)).thenReturn(orderDTO);
        ...
        // Perform assertions
        verify(orderService, atMostOnce()).deleteOrder(userId, id, false);
        assertNotNull(orderResponseEntity);
        assertEquals(orderResponseEntityExpected, orderResponseEntity);
    }
    ...
    void test_test_DeleteOrderFail1() throws NotFoundException {
        ...
        int id = 1;
        int userId = 1;
        when(orderService.deleteOrder(userId, id, false)).thenThrow(new NotFoundException(exceptionOrderNotFound));
        ...
        // Perform assertions
        verify(orderService, atLeastOnce()).deleteOrder(userId, id, false);
        assertNotNull(result);
        assertEquals(expected, result);
        assertEquals(expected.getStatusCode(), result.getStatusCode());
        assertEquals(expected.getBody(), result.getBody());
    ...
    void test_FullCancelOrderById() throws NotFoundException, WrongFlowException, BadPayloadException, InvalidQuantityException {
        ...
        when(orderService.fullCancelOrder(id, orderUpdateDTO, false)).thenReturn(orderDTOExpected);
        ...
        // Perform assertions
        verify(orderService, atMostOnce()).fullCancelOrder(id, orderUpdateDTO, false);
        assertNotNull(orderResponseEntity);
        assertEquals(orderResponseEntityExpected, orderResponseEntity);
    }
    ...
    void test_FullCancelOrderByIdFail1() throws InvalidQuantityException, BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.fullCancelOrder(id, orderUpdateDTO, false)).thenThrow(new NotFoundException(exceptionOrderNotFound));
        ...
        // Perform assertions
        verify(orderService, atLeastOnce()).fullCancelOrder(id, orderUpdateDTO, false);
        assertNotNull(result);
        assertEquals(expected, result);
        assertEquals(expected.getStatusCode(), result.getStatusCode());
        assertEquals(expected.getBody(), result.getBody());
    ...
    void test_FullCancelOrderByIdFail2() throws InvalidQuantityException, BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.fullCancelOrder(id, orderUpdateDTO, false)).thenThrow(new BadPayloadException(exceptionOrderBadRequest));
    ...
    void test_FullCancelOrderByIdFail3() throws InvalidQuantityException, BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.fullCancelOrder(id, orderUpdateDTO, false)).thenThrow(new InvalidQuantityException(exceptionOrderInvalidQuantity));
    ...
    void test_FullCancelOrderByIdFail4() throws InvalidQuantityException, BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.fullCancelOrder(id, orderUpdateDTO, false)).thenThrow(new WrongFlowException(exceptionOrderWrongFlow));
    ...
    void test_RejectOrderById() throws NotFoundException, WrongFlowException, BadPayloadException, InvalidQuantityException {
        ...
        when(orderService.rejectOrder(id, orderUpdateDTO, false)).thenReturn(orderDTOExpected);
        ...
        // Perform assertions
        verify(orderService, atLeastOnce()).rejectOrder(id, orderUpdateDTO, false);
        assertNotNull(orderResponseEntity);
        assertEquals(orderResponseEntityExpected, orderResponseEntity);
    }
    ...
    void test_RejectOrderByIdFail1() throws InvalidQuantityException, BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.rejectOrder(id, orderUpdateDTO, false)).thenThrow(new NotFoundException(exceptionOrderNotFound));
    ...
    void test_RejectOrderByIdFail2() throws InvalidQuantityException, BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.rejectOrder(id, orderUpdateDTO, false)).thenThrow(new BadPayloadException(exceptionOrderBadRequest));
    ...
    void test_RejectOrderByIdFail3() throws InvalidQuantityException, BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.rejectOrder(id, orderUpdateDTO, false)).thenThrow(new InvalidQuantityException(exceptionOrderInvalidQuantity));
    ...
    void test_RejectOrderByIdFail4() throws InvalidQuantityException, BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.rejectOrder(id, orderUpdateDTO, false)).thenThrow(new WrongFlowException(exceptionOrderWrongFlow));
    ...
    void test_ApproveOrderById() throws NotFoundException, WrongFlowException, BadPayloadException {
        ...
        when(orderService.approveOrder(id, orderUpdateDTO, false)).thenReturn(orderDTOExpected);
        ...
        // Perform assertions
        verify(orderService, atLeastOnce()).approveOrder(id, orderUpdateDTO, false);
        assertNotNull(orderResponseEntity);
        assertEquals(orderResponseEntityExpected, orderResponseEntity);
    }
    ...
    void test_ApproveOrderByIdFail1() throws BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.approveOrder(id, orderUpdateDTO, false)).thenThrow(new NotFoundException(exceptionOrderNotFound));
    ...
    void test_ApproveOrderByIdFail2() throws BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.approveOrder(id, orderUpdateDTO, false)).thenThrow(new BadPayloadException(exceptionOrderBadRequest));
    ...
    void test_ApproveOrderByIdFail3() throws BadPayloadException, NotFoundException, WrongFlowException {
        ...
        when(orderService.approveOrder(id, orderUpdateDTO, false)).thenThrow(new WrongFlowException(exceptionOrderWrongFlow));
