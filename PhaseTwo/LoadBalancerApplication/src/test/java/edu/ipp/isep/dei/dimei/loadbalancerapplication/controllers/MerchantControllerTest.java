...
class MerchantControllerTest {
    ...
    void test_GetAllMerchants() {
        ...
        when(restTemplate.exchange(MERCHANT_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);
        ...
        verify(restTemplate, times(1)).exchange(MERCHANT_URL + "/all", HttpMethod.GET, requestEntity, Object.class);
    ...
    void test_GetAllMerchantsFail1() {
        ...
        when(restTemplate.exchange(MERCHANT_URL + "/all", HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
    ...
    void test_GetMerchantById() {
        ...
        when(restTemplate.exchange(MERCHANT_URL + "/" + merchantDTO.getId(), HttpMethod.GET, requestEntity, Object.class)).thenReturn(mockResponseEntity);

        ResponseEntity<Object> response = merchantController.getMerchantById(jwtTokenDummy, merchantDTO.getId());

        verify(userController, times(1)).getUserId(jwtTokenDummy);
        verify(restTemplate, times(1)).exchange(MERCHANT_URL + "/" + merchantDTO.getId(), HttpMethod.GET, requestEntity, Object.class);
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
    ...
    void test_GetMerchantByIdFail1() {
        ...
        when(restTemplate.exchange(MERCHANT_URL + "/" + merchantDTO.getId(), HttpMethod.GET, requestEntity, Object.class)).thenThrow(new HttpClientErrorException(HttpStatus.INTERNAL_SERVER_ERROR, "Exception message"));
